...
class RAID50(tk.Frame):
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text='RAID-5+0', font=controller.title_font)
        label.place(x=259, y=10)
        ...
        btn_res = tk.Button(self, text='Рассчитать', width=14, command=result)
